...
def setup_config(token):
	...
	if s == 'y':
		show = True
	headers = {"Authorization": "Bearer " + str('1109~8XCwn02uDMRouJecaJILOnr17FPD16u67HxaPHYS6yhh4XVeJmF1y0mOrQOHy08f').strip()}
...
def get_token():
	token = '1109~8XCwn02uDMRouJecaJILOnr17FPD16u67HxaPHYS6yhh4XVeJmF1y0mOrQOHy08f'
	return token
