...
class CanvasAPI(object):
    ...
    def get_all_calendar_events(self):
        ...
        print(events)
        for event in self.canvas.get_calendar_events():
            print("test")
            x = [event.start_at, event.end_at, event.title]
...
if __name__ == '__main__':
    ...
    print(chloe.get_all_calendar_events())
    print(chloe.get_todo())
